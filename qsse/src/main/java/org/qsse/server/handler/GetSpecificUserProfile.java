...
public class GetSpecificUserProfile implements ActionHandler<GetUserProfile, UsersListResult> {

	private final QsseUserService userService;
	private final EntityManager entityManager ;
	
	@Inject
	public GetSpecificUserProfile(QsseUserService userService, EntityManager entityManager){
	...
	public UsersListResult execute(GetUserProfile action, ExecutionContext context) throws DispatchException {
		...
		String emailUser = action.getEmail();
